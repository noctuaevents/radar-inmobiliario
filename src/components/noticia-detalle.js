...
function LegalPage() {
  const secs = [
    ...
    { h: 'Cookies y rastreo', body: 'Esta publicación no muestra publicidad ni usa redes publicitarias de terceros. Utilizamos <strong>Vercel Web Analytics</strong>, una herramienta de analítica agregada y anónima, sin cookies de seguimiento, que nos permite conocer el número de visitas de forma estadística. No identifica a personas individuales ni cruza datos con otros servicios.' },
